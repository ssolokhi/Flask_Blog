...
from flask_blog import database, bcrypt, mail
from flask_blog.models import User, Post
from flask_blog.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                    RequestResetForm, ResetPasswordForm)
from flask_blog.users.utils import save_image, send_reset_email
...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.account')) # to avoid post-get-redirect pattern with next return
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email with instructions has been send to you.', 'info')
